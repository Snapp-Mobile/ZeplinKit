...
struct ZeplinKitMocks {
    ...
    static let addNoteRequest = ZeplinAddNoteRequest(
        project: ZeplinKitMocks.project,
    ...
    static let updateNoteRequest = ZeplinUpdateNoteRequest(
        project: ZeplinKitMocks.project,
        screen: ZeplinKitMocks.screen,
    ...
    static let addCommentRequest = ZeplinAddCommentRequest(
        project: ZeplinKitMocks.project,
        screen: ZeplinKitMocks.screen,
        note: ZeplinKitMocks.note,
        content: "Test comment"
    ...
    static let updateCommentRequest = ZeplinUpdateCommentRequest(
        project: ZeplinKitMocks.project,
        screen: ZeplinKitMocks.screen,
        note: ZeplinKitMocks.note,
    ...
    static let project = ZeplinProject(
        ...
        organization: ZeplinOrganizationSummary(
    ...
    static let screen = ZeplinScreen(
    ...
    static let organization = ZeplinOrganizationSummary(
        id: "5d9caaecb4a3fa9b972f86ce",
        name: "Acme, Inc.",
        logo: "http://placekitten.com/200/300"
    )
    ...
    static let notifications: [ZeplinNotificationRepresentation] = [
        ZeplinNotificationRepresentation(
    ...
    static let comment = ZeplinComment(
